...
class IncidentSerializer(serializers.ModelSerializer):
    ...
    def get_device_hash(self, obj):
        # 1. Safely check if the incident is linked to a RegisteredUser profile
        if obj.registered_user:
            # Return the unique tracking phone_hash generated by your app/USSD/SMS gateway
            return obj.registered_user.phone_hash
            
        # 2. Fallback text if an incident was reported anonymously or without an account
