...
// ── Success screen ─────────────────────────────────────────────────────────────
function RequestSubmitted({ onBackToWelcome, onSignIn }) {
  return (
    <div className="flex w-full h-screen overflow-hidden">
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-10" style={{ background: '#f5f4ef' }}>
        <div className="w-full max-w-sm flex flex-col items-center text-center gap-6">
          ...
          <ShieldCheck size={72} strokeWidth={1.4} style={{ color: '#3aaa7a' }} />

          <div className="space-y-2">
            <h2 className="text-2xl font-bold text-gray-900">Request submitted</h2>
            <p className="text-gray-400 text-sm leading-relaxed max-w-xs mx-auto">
              Our partnership team will review your organization and reach out within 2 business days.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3 w-full mt-2">
            <button
              ...
              className="w-full py-3.5 rounded-full text-white text-sm font-semibold transition-all duration-200 hover:opacity-90 active:scale-[0.98]"
              style={{ background: '#1b4332' }}
            >
              Back to welcome
            </button>
            <button
              onClick={onSignIn}
              className="w-full py-3.5 rounded-full text-gray-700 text-sm font-medium border border-gray-300 bg-white hover:border-gray-400 hover:text-gray-900 transition-all duration-200 active:scale-[0.98]"
            >
              I already have credential
            </button>
          </div>
...
// ── Main component ─────────────────────────────────────────────────────────────
export default function RequestAccess({ onSignIn, onWelcome }) {
